  ...
  return (
    <div className={`${darkMode ? "bg-gray-900 text-white" : "text-gray-800"} min-h-screen flex flex-col`}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="bg-gray-50 rounded-xl w-full p-10 dark:bg-gray-900">
          {/* Header Section */}
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-semibold text-gray-700">All Advertises</h2>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border-collapse text-gray-500">
              <thead>
                <tr>
                <th className="px-4 py-3 border-b text-left">Ad Image</th>
                  <th className="px-4 py-3 border-b text-left">Ad Name</th>
                  <th className="px-4 py-3 border-b text-left">Ad Title</th>
                  <th className="px-4 py-3 border-b text-left">Country(From)</th>
                  <th className="px-4 py-3 border-b text-left">Ad Resolution</th>
                  <th className="px-4 py-3 border-b text-left">Ad Type</th>
                  <th className="px-4 py-3 border-b text-left">Click count</th>
                  <th className="px-4 py-3 border-b text-left">Impr. Count</th>
                  <th className="px-4 py-3 border-b text-left">View Image</th>
                </tr>
              </thead>
              <tbody>
                <tr>
